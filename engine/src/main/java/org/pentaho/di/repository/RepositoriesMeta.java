...
public class RepositoriesMeta {
  ...
  public boolean readData() throws KettleException {
    ...
    // [liqiulin change from info to debug]
    if ( log.isDebug() ) {
      log.logDebug( BaseMessages.getString( PKG, "RepositoryMeta.Log.ReadingXMLFile", file.getAbsoluteFile() ) );
    }
  ...
  public void readDataFromInputStream( InputStream is ) throws KettleException {
    ...
    if ( log.isDebug() ) {
      log.logDebug( BaseMessages.getString( PKG, "RepositoryMeta.Log.ReadingXMLFile", "FromInputStream" ) );
    }
