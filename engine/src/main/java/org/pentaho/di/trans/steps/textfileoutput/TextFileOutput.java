      ...
      if ( nullString != null && v.isNull( valueData ) ) {
        ...
        if ( meta.isFastDump() ) {
          if ( valueData instanceof byte[] || 
        		  (v.getOriginalColumnTypeName() != null && v.getOriginalColumnTypeName().contains("BLOB")) ) {// binary
        	  ...
        	  if (valueData instanceof byte[]) {
        		  ...
        		  if(meta.getFileFormat().equals("UNIX")) {//MPP platform to binary bytea
            		  ...
            		  str = getBinaryString(Base64.getEncoder().encodeToString(valueData.toString().getBytes()));
            	  } else if(meta.getFileFormat().equals("ADQ")) {//DM platform
        	  ...
        	  else if (meta.getFileFormat().startsWith("ADQ")) {
							str = getBinaryString((valueData == null) ? ""
