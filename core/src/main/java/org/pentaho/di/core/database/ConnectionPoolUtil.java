...
public class ConnectionPoolUtil {
  ...
  public static final String REMOVE_ABANDONED_ON_BORROW = "removeAbandonedOnBorrow";
  ...
  private static void setPoolProperties( BasicDataSource ds, Properties properties, int initialSize, int maxSize ) {
    ...
    value = properties.getProperty( MAX_TOTAL );
    if ( !Utils.isEmpty( value ) ) {
    ...
    value = properties.getProperty( MAX_WAIT_MILLIS );
    if ( !Utils.isEmpty( value ) ) {
    ...
    value = properties.getProperty( REMOVE_ABANDONED_ON_BORROW );
    if ( !Utils.isEmpty( value ) ) {
