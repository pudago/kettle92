...
public class ValueMetaBase implements ValueMetaInterface {
  ...
  public static final String DEFAULT_DATE_PARSE_MASK = Const.NVL( EnvUtil
    .getSystemProperty( Const.KETTLE_DEFAULT_DATE_FORMAT ), "yyyy-MM-dd HH:mm:ss" );
  ...
  // [liqiulin]
  public static final Pattern PATTERN_NUL = Pattern.compile("\u0000");
        ...
        case ValueMetaInterface.TYPE_STRING:
          if ( !isNull( data ) ) {
            ...
            if ( getLength() <= databaseMeta.getMaxTextFieldLength() ) {
              // [liqiulin replace NUL character]
              preparedStatement.setString( index, PATTERN_NUL.matcher(getString( data )).replaceAll("") );
            } else {
